...
# Récupère le répertoire où se trouve ton script Python
current_dir = os.path.dirname(os.path.abspath(__file__))

# Définir les chemins relatifs par rapport à ce répertoire
agents_path = os.path.join(current_dir, 'src2', 'project', 'config', 'agents.yaml')
tasks_path = os.path.join(current_dir, 'src2', 'project', 'config', 'tasks.yaml')

# Vérifie les chemins absolus générés
print("agents_path:", agents_path)
print("tasks_path:", tasks_path)

# Charge la configuration avec les chemins absolus générés
